...
import 'package:weather_app/widgets/settings.dart' show Settings;
import "package:weather_app/theme/CustomTheme.dart";
...
class _MyAppState extends State<MyApp> {
  ...
  Future<Map<String, dynamic>> func() async {
    ...
    var url = await http.get(Uri.parse(
        'http://api.openweathermap.org/data/2.5/onecall?lat=$lat&lon=$lon&&appid=6ede73002eb494638609c2793f0a0b15'));
    var r = jsonDecode(url.body);
    return r;
  }
